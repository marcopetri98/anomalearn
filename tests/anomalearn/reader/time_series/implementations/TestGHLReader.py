...
class TestGHLReader(unittest.TestCase):
    ...
    def test_read(self):
        obj1 = self.reader.read("train").get_dataframe().to_numpy()
        obj2 = self.reader.read(0).get_dataframe().to_numpy()
        obj3 = self.reader.read(1).get_dataframe().to_numpy()
        obj4 = self.reader.read(15).get_dataframe().to_numpy()
